...
const MiddlePart = () => {
  ...
  const handleOpenCreatePostModal = () => {
    ...
    console.log("handle open post model");
  };
  useEffect(()=>{
  ...
  return (
    <div className="px-20">
      ...
      <Card className="p-5 mt-5">
        ...
        <div className="flex justify-center space-x-9 mt5">
      ...
      <div>
        <CreatePostModel handleClose={handleCloseCreatePostModal} open={openCreatePostModal}/>
      </div>
    </div>
  );
};
